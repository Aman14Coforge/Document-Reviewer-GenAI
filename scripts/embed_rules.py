"""Embed GDP rules into ChromaDB using all-MiniLM-L6-v2."""
...
from src.rag.rule_store import embed_rules
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Embed rules from rules.json into ChromaDB (all-MiniLM-L6-v2)."
    )
    parser.add_argument(
        "--rules",
